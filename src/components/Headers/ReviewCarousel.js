...
const items = [
  {
    content: (
      <Card className="card-testimonial card-plain">
        ...
        <CardBody>
          <h5 className="card-description" style={{ color: "black" }}>
          ...
          <CardTitle tag="h4" className="my-1">
            Stefan
          </CardTitle>
      ...
      >
        <div
          ...
          style={{
            ...
            width: "100%",
            backgroundImage:
              "url(" + require("../../assets/img/Artboard7.svg") + ")",
          ...
          <Row className="text-center">
            <Col md={12}>
              <h2
                ...
                className="title my-0 pt-0"
                style={{ width: "100%", fontFamily:"Lato, Montserrat,Helvetica Neue, Arial, sans-serif" }}
              >
                {" "}
                TESTIMONIALS
              </h2>
...
></div> */}
                <ScrollRotate loops={0.1} method={"perc"} from={0} to={30}>
                  <div
                    className="bg-elements rellax left-second-person"
                    id="bg-elements-2"
                    data-rellax-speed="-3"
                    style={{
                      minHeight: "10vw",
                ...
                <ScrollRotate loops={3} method={"perc"} from={0} to={30}>
                  <div
                    className="bg-elements   left-fifth-person"
                    id="bg-elements-1"
                    data-rellax-speed="-4"
                    style={{
                      marginLeft: "5vw",
            ...
            <Col md="2">
              <div className="testimonials-people">
                <ScrollRotate loops={3} method={"perc"} from={110} to={150}>
                  <div
                    className="bg-elements   right-fifth-person"
                    id="bg-elements-4"
                    data-rellax-speed="-4"
                    style={{
                      minHeight: "20vw",
