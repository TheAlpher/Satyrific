...
<Container >
<CardTitle tag='h6' data-aos="zoom-in-up" data-aos-duration="1000" className='text-center' style={{color:'grey'}}>TESTIMONIALS</CardTitle>
    <CardTitle tag='h3'  data-aos="zoom-in-up" data-aos-duration="1000" className='text-center' style={{fontWeight:'bold'}}>What Our Customers Say</CardTitle>
<hr  data-aos="zoom-in" data-aos-duration="2000" style={{width:'20%',border:'3px solid orange',borderRadius:'3px'}}/>
</Container>
...
>
              ...
              return (
                ...
                >
                  <div   className="page-header header-filter" style={{
                    minHeight:'unset',maxHeight:'59vh'}}>
                    <div
        ...
        <CardBody style={{marginTop:0,paddingTop:'1%'}}>
          <h4 className="card-description" style={{color:'white',fontSize:'0.8rem'}}>
